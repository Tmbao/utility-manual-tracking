...
from custom_components.utility_manual_tracking.consts import CONF_METER_CLASS, CONF_METER_NAME, CONF_METER_UNIT, DOMAIN
...
class UtilityManualTrackingSensor(SensorEntity):
    def __init__(self, meter_name: str, meter_unit: str, meter_class: str) -> None:
        super().__init__()
        self._attr_unique_id = f"{DOMAIN}_{meter_name.lower().replace(' ', '_')}_{meter_unit.lower()}"
